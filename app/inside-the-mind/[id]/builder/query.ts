...
export const SANITY_INSIDE_THE_MIND_ARTICLE_PAGE_QUERY = groq`
	*[_type == "insideTheMindArticle" && seo.slug.current == $slug][0]{
...
export const SANITY_INSIDE_THE_MIND_ARTICLE_PAGE_SEO_QUERY = groq`
	*[_type == "insideTheMindArticle" && seo.slug.current == $slug][0]{
		${SANITY_SEO_DATA_QUERY_FRAGMENT}
	}
`;

export const SANITY_ALL_INSIDE_THE_MIND_ARTICLE_PAGES_QUERY = groq`
