        ...
        <CustomSheet
          ...
          content={
            <>
              ...
              <div className="font-semibold absolute top-0 w-full border-b border-gray-light bg-white px-5 py-4 text-center">
                <Typography
                  size="h3"
              ...
              <div className="font-semibold absolute bottom-0 w-full border-t border-gray-light bg-white p-5 text-center">
                <CustomButton
                  type="action"
                  colorScheme="primary"
                  onButtonClick={() => {
